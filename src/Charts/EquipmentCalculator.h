...
class EquipmentOverviewWindow;

class EquipCalculator
{
    public:
        EquipCalculator(const MainWindow* mainWindow, EquipmentOverviewWindow* eqOverviewWindow);
    ...
    protected:
        ...
        EquipmentOverviewWindow* eqOverviewWindow_;
};
