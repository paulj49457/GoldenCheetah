...
class AnalysisOverviewWindow : public OverviewWindow {
    ...
    protected:
        ...
        AddTileWizard* getTileWizard(ChartSpaceItem* &added) const override { return new AddTileWizard(space, OverviewScope::ANALYSIS, added); }
};
...
class PlanOverviewWindow : public OverviewWindow {
    ...
    protected:
        ...
        AddTileWizard* getTileWizard(ChartSpaceItem* &added) const override { return new AddTileWizard(space, OverviewScope::PLAN, added); }
};
...
class TrendsOverviewWindow : public OverviewWindow {
    ...
    protected:
        ...
        AddTileWizard* getTileWizard(ChartSpaceItem* &added) const override { return new AddTileWizard(space, OverviewScope::TRENDS, added); }
};
...
class EquipmentOverviewWindow : public OverviewWindow
{
    ...
    public:
        ...
        EquipmentOverviewWindow(MainWindow *mainWindow, bool blank = false);
    ...
    protected:
        ...
        AddTileWizard* getTileWizard(ChartSpaceItem* &added) const override { return new AddTileWizard(space, OverviewScope::EQUIPMENT, added); }

        void getTileConfig(ChartSpaceItem* item, QString& config) const override;
        ChartSpaceItem* setTileConfig(const QJsonObject& obj, int type, const QString& name,
                           const QString& datafilter, int order, int column,
                           int span, int deep) const override;
