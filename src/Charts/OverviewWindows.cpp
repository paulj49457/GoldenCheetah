...
AnalysisOverviewWindow::AnalysisOverviewWindow(Context* context, bool blank) :
    OverviewWindow(context, context->mainWindow, OverviewScope::ANALYSIS, blank)
{
...
PlanOverviewWindow::PlanOverviewWindow(Context* context, bool blank) :
    OverviewWindow(context, context->mainWindow, OverviewScope::PLAN, blank) {
...
TrendsOverviewWindow::TrendsOverviewWindow(Context* context, bool blank) :
    OverviewWindow(context, context->mainWindow, OverviewScope::TRENDS, blank) {
...
EquipmentOverviewWindow::EquipmentOverviewWindow(MainWindow *mainWindow, bool blank) :
    OverviewWindow(nullptr, mainWindow, OverviewScope::EQUIPMENT, blank), eqWindowVisible_(false),
                                       ...
                                       int order, int column, int span, int deep) const
{
    ...
    default:
    {
        add = OverviewWindow::setTileConfig(obj, type, name, datafilter, order, column, span, deep);
    }
    break;
    }
