...
class OverviewWindow : public GcChartWindow
{
    ...
    protected:
        ...
        OverviewWindow(Context* context, MainWindow *mainWindow, OverviewScope scope, bool blank);
        ...
        virtual ChartSpaceItem* setTileConfig(const QJsonObject& obj, int type, const QString& name,
