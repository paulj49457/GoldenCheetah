...
class AbstractView : public QWidget
{
    ...
    protected:
        ...
        AbstractView(MainWindow *mainWindow, const QString& viewsInternalName, const QString& heading);
        AbstractView(Context *context, const QString& viewsInternalName, const QString& heading);
        ...
        Context *context; // this is only set for athlete specific views, otherwise nullptr
    ...
    private:
        void initialise(const QString& heading);
};
...
protected:
    ...
    // Hide constructor to create an Abstract class
    ViewParser(Context* context, MainWindow *mainWindow, bool useDefault) : style(2), context(context), mainWindow(mainWindow), useDefault(useDefault) {}
