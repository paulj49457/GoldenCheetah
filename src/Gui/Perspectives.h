...
class AnalysisPerspective : public Perspective {
    ...
    public:
        ...
        QString viewsInternalName() const override;
...
class EquipmentPerspective : public Perspective {
    ...
    public:
        EquipmentPerspective(MainWindow *mainWindow, const QString& title);
        ...
        bool relevant(RideItem*) const override { return false; }
        QStringList filterlist(DateRange, bool, QStringList) override { return QStringList(); }
        bool setExpression(const QString&) override { return false; }
        void setTrainSwitch(int) override {}
    ...
    protected:
        GcChartWindow* getNewGcWindow(GcWinID type) const override;
        ViewParser* getViewParser(bool useDefault) const override;
