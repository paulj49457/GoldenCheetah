...
class ChartSpace : public QWidget
{
    ...
    public:
        ...
        ChartSpace(Context *context, MainWindow *mainWindow, OverviewScope scope, GcWindow *window);
        ...
        // used by children
        Context *context; // this is only set for athlete specific charts, otherwise nullptr
