...
AdditionsPage::AdditionsPage(Context *context) : context(context)
{
    ...
    additions.append("");
    additions.append("<i>August 2026 custom build</i>");
    additions.append("");
    ...
    additions.append("Single Named Searches file");
    additions.append("Appveyor gc executable generation");
    additions.append("Help About Additions tab");
