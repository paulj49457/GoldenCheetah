...
{  
    ...
    protected:
        ...
        Perspective* getViewsPerspective(const QString& name) const override { return new EquipmentPerspective(context, name); }
        ViewParser* getViewParser(Context* context, bool useDefault) const override { return new EquipmentViewParser(context, useDefault); }
