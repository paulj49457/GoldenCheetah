...
GcWindowRegistry::initialize()
{
  static GcWindowRegistry GcWindowsInit[35] = {
    ...
    { VIEW_EQUIPMENT, tr("Equipment Overview"),GcWindowTypes::OverviewEquipment },
...
GcWindowRegistry::newGcWindow(GcWinID id, Context *context)
{
    ...
    case GcWindowTypes::OverviewEquipment: returning = new EquipOverviewWindow(context, EQUIPMENT); if (id != GcWindowTypes::OverviewEquipment) { id = GcWindowTypes::OverviewEquipment; static_cast<EquipOverviewWindow*>(returning)->setConfiguration(""); } break;
