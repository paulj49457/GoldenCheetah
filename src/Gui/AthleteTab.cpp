...
AthleteTab::indexToViewType(int index) const
{
    ...
    switch (index) {
        ...
        default: {
            qCritical() << "Unhandled view index in AthleteTab, returning NO_VIEW_SET !";
            return GcViewType::NO_VIEW_SET;
        } break;
    }
}
...
AthleteTab::viewTypeToIndex(GcViewType viewType) const
{
    ...
    switch (viewType) {
        ...
        default: {
            qCritical() << "Unhandled view type in AthleteTab, returning index NO_VIEW_SET !";
            return -1;
        } break;
    }
}
